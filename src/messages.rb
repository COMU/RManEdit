...
TURKISH = _("Türkçe")
GERMAN = _("Almanca")
RESTART = _("Program yeniden başlatılacağı için değişiklikleriniz kaybedilecek.")
ABOUT = _("Hakkında")
APP_ABOUT = _("Uygulama Hakkında Açıklamalar")
APP_INFO = _("Uygulama Creative Commons ile lisanlanmıştır.\nUygulama yazarı: Ebru Akagündüz")
OK = _("Tamam")
